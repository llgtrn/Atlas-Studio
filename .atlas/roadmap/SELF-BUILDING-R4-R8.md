...
Canonical main now has a useful R4.8 bootstrap: single-level self.field READ/WRITE extraction, compound-assignment read-modify-write hardening, conservative panic-like macro candidates, and (new this generation) conservative filesystem-effect candidates. This is not R4.8 semantic closure.
