...
const nonServerProjects = [
  "@chronica/shared",
  "@chronica/db",
  "@chronica/adapter-utils",
  "@chronica/adapter-acpx-local",
  "@chronica/adapter-codex-local",
  "@chronica/adapter-opencode-local",
  "@chronica/plugin-sdk",
  "@chronica/ui",
  "paperclipai",
];
...
const generalWorkspacesAProjects = ["@chronica/ui", "paperclipai"];
...
function runGeneralGroup(routeTests, groupName) {
  if (groupName === generalServerGroupName) {
    ...
    runVitest(
      ["--project", "@chronica/server", ...excludeRouteArgs],
