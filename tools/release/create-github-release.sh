...
usage() {
  cat <<'EOF'
Usage:
  ./tools/release/create-github-release.sh <version> [--dry-run]

Examples:
  ./tools/release/create-github-release.sh 2026.318.0
  ./tools/release/create-github-release.sh 2026.318.0 --dry-run
