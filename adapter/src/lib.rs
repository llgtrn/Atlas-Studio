...
pub use source::{
    ...
    SemanticSourceUnit, SourceFrontend, SourceFrontendMatch, inventory_declared_source,
    inventory_source, resolve_source_frontend, scan_declared_source, scan_source, source_frontends,
...
pub fn audit_docs(root: impl AsRef<Path>) -> io::Result<DocsReport> {
    ...
    let required = [
        ...
        "contracts/schema/census-certificate.v1.schema.json",
        "decisions/README.md",
        "decisions/0001-one-normalized-semantic-path.md",
        "decisions/0002-epistemic-status-model.md",
        "genome/atlas.genome.toml",
        "roadmap/ROADMAP.md",
        "roadmap/R4-COMPLETION-MATRIX.md",
