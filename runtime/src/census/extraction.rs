...
mod multi_extractor_tests {
    ...
    // --- 12. R4.6: a real Rust extractor is now registered, scoped to exactly 6 dimensions -----

    #[test]
    fn a_real_rust_extractor_is_registered_supporting_exactly_the_r4_6_dimensions() {
