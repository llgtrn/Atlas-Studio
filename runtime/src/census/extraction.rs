...
mod multi_extractor_tests {
    ...
    // --- 12. R4.7: a real Rust extractor is now registered, scoped to exactly 7 dimensions -----

    #[test]
    fn a_real_rust_extractor_is_registered_supporting_exactly_the_r4_7_dimensions() {
