...
pub fn systemize(root: impl AsRef<Path>) -> io::Result<SystemizeReport> {
    ...
    Ok(SystemizeReport {
        ...
        invariants: vec![
            ...
            "FACT_KIND_EVIDENCE_KIND_EPISTEMIC_STATUS_AND_DISPOSITION_ARE_DISTINCT".into(),
            "SEMANTIC_EXTRACTORS_DO_NOT_OWN_GRAPH_TRUTH".into(),
            "NORMALIZATION_PRESERVES_PROVENANCE".into(),
            "NORMALIZED_ID_EXCLUDES_RAW_EXTRACTOR_ID".into(),
